...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1yLXNheWVkIiwiYSI6ImNscWswMDdnMzJjbXoyb21rejl1bjV2MnUifQ.F8AtFZdAGJ0ol4GRlMAclQ';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51OSKGJEDcV8el2RU9acxyZRN3IXL5jW4wRM1yVCSCRMraGmGmJ3Hf9UbLPOY0vmgycsJQQxMis9i6suMt1LxO77p00AagIaHh0'); // Get checkout session from API
          _context.next = 4;
...
var resetPassword = document.querySelector('form--respass');
